...
module.exports = class HMrequest {
    static async nekosGet(name) {
        const blacklist = ['https://cdn.nekos.life/blowjob/blowjob31.jpg', 'https://cdn.nekos.life/blowjob/blowjob32.jpg', 'https://cdn.nekos.life/lewdkemo/lewd_neko_v2_132.jpg', 'https://cdn.nekos.life/Random_hentai_gif/Random_hentai_gifNB_1039.gif']
        let res = await fetch(`https://nekos.life/api/v2/img/${name}`).then(res => res.json()).catch(err => errMessage(err));
    ...
    static async freakerGet(name) {
        ...
        let res = await fetch(`https://api.computerfreaker.cf/v2/${name}`, { method: 'GET', headers: headers }).then(res => res.json()).catch(err => errMessage(err))
        return res;
    }
}